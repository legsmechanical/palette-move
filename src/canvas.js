/* GENERATED by schwung-canvaskit v8 — DO NOT EDIT THIS FILE.
...
/* Layout: 7px header (+ its rule on row 7), then two 19px widget rows each
 * with a 7px label strip beneath, filling the full 64 rows exactly:
 * hdr 0-6 | rule 7 | gap 8 | w0 9-27 | gap 28 | lbl0 29-35 | gap 36 |
 * w1 37-55 | gap 56 | lbl1 57-63. */
const ROW0_Y = 9, LBL0_Y = 29, ROW1_Y = 37, LBL1_Y = 57;
