/* GENERATED by schwung-canvaskit v21 — DO NOT EDIT THIS FILE.
...
function drawChrome(ctx, headerLabel, s, swap) {
  ...
  if (swap) {
    ...
    njPrint(ctx, Math.max(2, Math.round((ctx.width - njWidth(t)) / 2)), 1, t, 0);
  } else {
    njPrint(ctx, 2, 1, t, 1);
  }
...
function drawStepEditor(ctx, bank, s) {
  ...
  if (s.lastKnob >= 0 && page * 8 + s.lastKnob < count) {
    ...
    njPrint(ctx, ctx.width - 2 - njWidth(rd), 1, rd, 1);
  }
