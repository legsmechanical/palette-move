/* GENERATED by schwung-canvaskit v23 — DO NOT EDIT THIS FILE.
...
function drawChrome(ctx, headerLabel, s, swap) {
  ...
  njPrint(ctx, 2, 1, t, 1);
  // Page-indicator bar on row 10 (+11 active), resting state only (movy's
...
/* Layout: 8px header (Chunky Sans 6 text) + blank rows + the indicator
 ...
 * hdr 0-7 (text 1-6) | blank 8-9 | bar 10 (+11 active) | gap 12 |
...
function drawStepEditor(ctx, bank, s) {
  ...
  const dY = HDR_H + 6, dBot = ctx.height - 2, dH = dBot - dY; // frame top clears the indicator bar
