/* GENERATED by schwung-canvaskit v6 — DO NOT EDIT THIS FILE.
...
function drawChrome(ctx, headerLabel, s, swap) {
  ...
  if (swap) {
    ...
    ctx.print(2, 1, t, 1);
    ctx.fillRect(0, HDR_H - 1, ctx.width, 1, 1);
  }
}
...
/* Layout: 7px inverted header, then two 19px widget rows each with a 7px
 * label strip beneath, filling the full 64 rows exactly:
 * hdr 0-6 | gap 7-8 | w0 9-27 | gap 28 | lbl0 29-35 | gap 36 |
...
function drawStepEditor(ctx, bank, s) {
  ...
  const dY = HDR_H + 3, dBot = ctx.height - 2, dH = dBot - dY;
