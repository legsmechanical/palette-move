/* GENERATED by schwung-canvaskit v4 — DO NOT EDIT THIS FILE.
...
/* Layout: 9px inverted header, then two 19px widget rows each with a 7px
 * label strip beneath, filling the full 64 rows. */
